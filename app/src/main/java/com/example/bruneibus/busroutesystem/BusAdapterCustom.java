...
public class BusAdapterCustom extends RecyclerView.Adapter<BusAdapterCustom.CustomViewHolder> {
    ...
    public BusAdapterCustom(Context context, ArrayList<BusClassCustom> busClasses) {
        this.context = context;
        this.busClassCustoms = busClasses;
        initialize_array();
    }
    ...
    @Override
    public BusAdapterCustom.CustomViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.mainlayout,parent,false);
        return new CustomViewHolder(view);
    }

    @Override
    public void onBindViewHolder(BusAdapterCustom.CustomViewHolder holder, int position) {
        BusClassCustom busClass=busClassCustoms.get(position);
        int img=0;
        int index=0;
        ...
        public CustomViewHolder(View view) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    BusClassCustom busitem=busClassCustoms.get(pos);
